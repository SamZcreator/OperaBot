...
OperaBotMobile is a companion for the OperaBot desktop application and does not use a developer-hosted login.

To review the app:

1. Install and start OperaBot on a Mac, Windows, or Linux computer.

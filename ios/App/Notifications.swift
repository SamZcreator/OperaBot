...
final class NotificationCoordinator: NSObject, UNUserNotificationCenterDelegate {
    ...
    func deliver(_ notification: NotificationFrame, sequence: Int?) {
        ...
        content.categoryIdentifier = notification.isBlocking ? "OPERABOT_APPROVAL" : "OPERABOT_UPDATE"
        ...
        let identifier = "operabot.\(notification.threadId).\(sequence.map(String.init) ?? notification.title)"

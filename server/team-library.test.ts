  ...
  teams: [
    {
      ...
      manifest: "teams/engineering/team.masqueteam.json",
...
describe("team library", () => {
  it("validates catalog paths and adds the trusted repository URL", () => {
    ...
    expect(parsed.repositoryUrl).toBe("https://github.com/SamZcreator/operabot-teams");
  ...
  it("loads only the manifest selected by the trusted catalog", async () => {
    const fetcher = vi.fn(async (url: string | URL | Request) => {
      ...
      if (target === `${TEAM_LIBRARY_RAW_ROOT}/teams/engineering/team.masqueteam.json`) return response(manifest);
      return response({}, 404);
  ...
  it("normalizes public GitHub repository, blob, and raw links", () => {
    expect(githubManifestUrls("https://github.com/acme/team")).toEqual([
      "https://raw.githubusercontent.com/acme/team/main/team.masqueteam.json",
      "https://raw.githubusercontent.com/acme/team/master/team.masqueteam.json",
    ]);
    expect(githubManifestUrls("https://github.com/acme/team/blob/main/presets/seo.masqueteam.json")).toEqual([
      "https://raw.githubusercontent.com/acme/team/main/presets/seo.masqueteam.json",
    ]);
    expect(githubManifestUrls("https://raw.githubusercontent.com/acme/team/main/team.masqueteam.json")).toEqual([
      "https://raw.githubusercontent.com/acme/team/main/team.masqueteam.json",
    ]);

...
import type { MasqueColor, MasqueMotion } from "@/lib/mascot";
...
export type { MasqueColor } from "@/lib/mascot";
...
export interface Message {
  ...
  from?: { botId: string; name: string; color: MasqueColor };
  /** emoji reactions; by = "user" or a member botId. */
  reactions?: Array<{ emoji: string; by: string }>;
  /** comm chips: "Messaged @X" linking to the bot⇄bot channel. */
  comm?: { groupId: string; withBotId: string; withName: string; withColor: MasqueColor };
...
export interface AppState {
  ...
  mascotMotion: {
    botId: string;
    nonce: number;
    kind: Exclude<MasqueMotion, "none">;
  } | null;
}

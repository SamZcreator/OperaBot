...
const COMMUNITY_TEAMS_REPOSITORY = "https://github.com/SamZcreator/operabot-teams";
                ...
                <div>
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    ...
                    >
                      ...
                      <span className="mt-1 text-[12.5px] text-ink-secondary">or drop a .masqueteam.json here</span>
                    </button>

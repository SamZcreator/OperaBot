...
export function CompanionSection() {
  ...
  if (!bridge()) {
    return (
      <Card
        title="Companion"
        subtitle="The companion runs as its own process, which only the desktop app can start. Open OperaBot on this computer to turn it on."
      >
        <div />
      </Card>
    );
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        ...
        {state.enabled && state.tailscale && !state.tailnetName && (
          <div className="mt-3 text-[13px] text-ink-secondary">
            ...
            OperaBot log for which paths were tried.
          </div>
        )}
      ...
      <Card
        ...
        subtitle={
          state.pairing
            ? pairingLink
              ? "Scan with your phone's Camera, then confirm in OperaBotMobile. You can also use the code manually."
              : "Open OperaBotMobile, choose this computer, and enter the code."
            : state.enabled

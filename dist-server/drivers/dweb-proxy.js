...
var DWEB = (process.env.DWEB_URL ?? "http://127.0.0.1:49737").replace(/\/+$/, "");
var DWEB_DISPLAY = (() => {
  try {
...
var TOOLS = [
  ...
  },
  {
    ...
    description: "Report the state of the OperaBot repository the dweb daemon is tracking: repo name, checked-out branch, last commit, file count, and checkout path.",
    inputSchema: { type: "object", properties: {} }
  },
  {
...
${lines.join("\n")}` };
  ...
  if (name === "dweb_opencode_run") {
    ...
    if (args.model !== void 0 && typeof args.model !== "string") {
    ...
    const r = await api("/api/opencode/run", {
      method: "POST",
      body: JSON.stringify({ command, ...model !== void 0 ? { model } : {} }),
